...
export const Main = () => {
  ...
  return (
    <main className="flex h-screen w-screen items-center justify-center bg-P1 p-5">
      <section className="flex h-[880px] w-[730px] flex-col items-center justify-center gap-10 rounded-xl bg-white p-5 shadow-center shadow-N7/20">
        <Image src={logoQBills} alt="QBills" width={285} quality={30} priority className="h-auto" />
