  ...
  return (
    <label
      ...
      className={clsx("font-semibold", {
        ...
        // SIZE MEDIUM
        // DEFAUTL
        "absolute cursor-text group-focus-within:static group-focus-within:cursor-default group-focus-within:text-sm group-focus-within:text-N3":
          value === "" && !error && !disabled && size === "md",
        "static text-sm text-N3": value !== "" && !error && !disabled && size === "md",

        // ERROR
        "absolute cursor-text group-focus-within:static group-focus-within:cursor-default group-focus-within:text-sm":
          value === "" && error && !disabled && size === "md",
