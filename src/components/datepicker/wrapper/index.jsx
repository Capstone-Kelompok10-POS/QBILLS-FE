...
export const Wrapper = ({ size, value, children, supText, supLabel, error, disabled }) => {
  return (
    <section>
      <div
      ...
      >
        <div className="flex h-full w-full items-center justify-center gap-2">{children}</div>
      </div>
